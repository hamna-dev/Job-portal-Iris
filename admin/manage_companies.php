...
// Uncomment this block to restrict access to admin users only
// if ($user_type !== 'admin') {
...
$sql = "SELECT * FROM company WHERE user_type = 'company'";
    ...
    <div class="admin-container">
        ...
        <table class="admin-table">
            ...
            <tr>
                ...
                <td><h3><?php echo htmlspecialchars($row['company_name']); ?></h3></td>
                <td><h3><?php echo htmlspecialchars($row['email']); ?></h3></td>
                <td class="btn-container">
                    <a href="#" class="btn-edit" style="color:white;">Edit</a>
                    <a href="delete_company.php?delete_id=<?php echo $row['company_id']; ?>" class="btn-delete" style="color:white;" onclick="return confirm('Are you sure you want to delete this company?')">Delete</a>
                </td>
            </tr>
            <?php 
                }
