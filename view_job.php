...
if (isset($_GET['id'])) {
    ...
    $job_query = "SELECT jobs.*, company.company_name, company.company_location FROM jobs INNER JOIN company ON jobs.company_id = company.company_id WHERE job_id = $job_id";
    ...
    <section class="job-details">
        ...
        <div class="details">
            <div class="job-info">
                ...
                <a href="view_company.php?company_id=<?php echo $job_row['company_id']; ?>"><?php echo $job_row['company_name']; ?></a>
                <p><i class="fas fa-map-marker-alt"></i><?php echo $job_row['company_location']; ?></p>
            </div>
            ...
            <div class="description">
                ...
                <ul>
                    ...
                    <?php
                        $posted_days_ago = date_diff(date_create($job_row['created_at']), date_create('today'))->format('%a');
                        ?>
        ...
        <div class="apply-button">
            <a href="apply_job.php?job_id=<?php echo $job_row['job_id']; ?>" class="btn">Apply</a>
        </div>
    </section>
